...
Document summarization:
    ...
    - The document summaries are generated using the "textrank" package provided by npm. Here's the link: https://www.npmjs.com/package/textrank
    - This library is an implementation of the following paper: https://web.eecs.umich.edu/~mihalcea/papers/mihalcea.emnlp04.pdf
    - The keywords and keyphrases are generated using the following library: https://github.com/retextjs/retext-keywords
